        ...
        <div className="lg:col-span-2">
          ...
          <Card className="mt-6">
            ...
            <CardContent>
              <div className="space-y-4">
                <p className="text-dark-300">
                  Your rehabilitation data is securely stored and used to improve your recovery journey.
                </p>
                ...
                <div className="flex space-x-4">
                  ...
                  <Button variant="outline" size="sm" className="text-error-400 border-error-800 hover:bg-error-900/30">
                    Delete Account
                  </Button>
                </div>
              </div>

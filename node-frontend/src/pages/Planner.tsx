...
//                 iconPosition="left"
//                 onClick={() =>
//                   navigate(`/exercise?exercise=${exercise.name.toLowerCase().replace(/\s+/g, '_')}`)
//                 }
...
//       {/* Exercise Details Modal - Updated with wider content instead */}
//       {selectedExercise && (
//         <Modal
//           isOpen={modalOpen}
...
const ExerciseCatalog: React.FC = () => {
  ...
  const handleStartExercise = (exercise: Exercise) => {
    ...
    // Using event.preventDefault() to ensure no default actions interfere
